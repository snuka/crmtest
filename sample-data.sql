...
VALUES
  ('plan-1111-aaaa-bbbb-cccc-dddddddddddd', 'Basic CRM', 'Basic CRM features for small businesses', 29.99, 'monthly', '{"users": 5, "storage": "10GB", "email_tracking": true, "api_access": false}'),
  ('plan-2222-aaaa-bbbb-cccc-dddddddddddd', 'Professional CRM', 'Advanced CRM for growing businesses', 49.99, 'monthly', '{"users": 20, "storage": "50GB", "email_tracking": true, "api_access": true, "advanced_analytics": true}'),
  ('plan-3333-aaaa-bbbb-cccc-dddddddddddd', 'Enterprise CRM', 'Full-featured CRM for large enterprises', 99.99, 'monthly', '{"users": 100, "storage": "500GB", "email_tracking": true, "api_access": true, "advanced_analytics": true, "dedicated_support": true}'),
  ('plan-4444-aaaa-bbbb-cccc-dddddddddddd', 'Basic Annual', 'Basic CRM with annual billing', 299.90, 'annually', '{"users": 5, "storage": "10GB", "email_tracking": true, "api_access": false}'),
  ('plan-5555-aaaa-bbbb-cccc-dddddddddddd', 'Professional Annual', 'Professional CRM with annual billing', 499.90, 'annually', '{"users": 20, "storage": "50GB", "email_tracking": true, "api_access": true, "advanced_analytics": true}');
...
VALUES
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'plan-2222-aaaa-bbbb-cccc-dddddddddddd', 'active', '2023-01-15', '2024-01-15', '{"type": "credit_card", "last4": "4242", "brand": "Visa"}'),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'plan-3333-aaaa-bbbb-cccc-dddddddddddd', 'active', '2023-03-10', '2024-03-10', '{"type": "credit_card", "last4": "5678", "brand": "Mastercard"}'),
  ('cccccccc-cccc-cccc-cccc-cccccccccccc', 'plan-1111-aaaa-bbbb-cccc-dddddddddddd', 'active', '2023-06-01', '2023-12-01', '{"type": "paypal", "email": "tony@stark.com"}'),
  ('dddddddd-dddd-dddd-dddd-dddddddddddd', 'plan-5555-aaaa-bbbb-cccc-dddddddddddd', 'active', '2023-02-20', '2024-02-20', '{"type": "bank_transfer", "account_last4": "9876"}');
